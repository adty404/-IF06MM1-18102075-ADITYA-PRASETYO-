...
import com.ppb.aditya_prasetyo18102075.praktikum9.databinding.ActivitySettingPreferenceBinding
...
class SettingPreferenceActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun showPreferenceInForm() {
        ...
        binding.edttgllahir.setText(settingModel.birthday)
        binding.edtjeniskelamin.setText(settingModel.sex)
    ...
    private fun saveSetting(name: String, email: String, age: String, phoneNo: String, birthday: String, sex: String, isLoveMU: Boolean) {
        ...
        settingModel.birthday = birthday
        settingModel.sex = sex
    ...
    override fun onClick(p0: View?) {
        if (p0?.id == R.id.btn_save) {
            ...
            val birthday = binding.edttgllahir.text.toString().trim()
            val sex = binding.edtjeniskelamin.text.toString().trim()
            ...
            if (birthday.isEmpty()) {
                binding.edttgllahir.error = getString(R.string.field_required)
                return
            }
            if (sex.isEmpty()) {
            ...
            saveSetting(name, email, phoneNo, age, birthday, sex, isLoveMU)
